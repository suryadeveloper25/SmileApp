          ...
          {filters.map(filter => {
            ...
            return (
              <TouchableOpacity
                ...
                style={[
                  styles.tab,
                  selectedFilter === filter.key && styles.tabSelected
                ]}
                onPress={() => setSelectedFilter(filter.key)}
                activeOpacity={0.7}
              >
                <Text
                  style={[
                    styles.tabText,
                    selectedFilter === filter.key && styles.tabTextSelected
                  ]}
                >
                  {filter.label} ({count})
                </Text>
                ...
                {filter.key !== 'all' && (
                  <View
                    style={[
                      styles.dot,
                      filter.key === 'leave' && styles.dotLeave,
                      filter.key === 'permission' && styles.dotPermission,
                    ]}
                  />
                )}
              </TouchableOpacity>
        ...
        >
          {sortedDates.length === 0 ? (
            <View style={styles.emptyState}>
              <MaterialIcons name="event-busy" size={64} color="#A0A3BD" />
                  ...
                  <View key={idx} style={styles.leaveCard}>
                    ...
                    <View style={styles.detailsContainer}>
                      ...
                      <View style={styles.detailRow}>
                        <Text style={styles.detailLabel}>Apply Type:</Text>
                        <Text style={styles.detailValue}>
                          {leave.leave_appln_type || '-'}
                        </Text>
                      </View>
                      ...
                      <View style={styles.detailRow}>
                        ...
                        <Text style={styles.detailValue} numberOfLines={2}>
                          {leave.leave_reason || leave.prmsn_reason || '-'}
                        </Text>
                      </View>

                      {/* Leave Details (for Leave type) */}
                      {(leave.leave_appln_type === 'Leave' ||
                        leave.leave_appln_type === 'All') && (
                          <>
                            <View style={styles.detailRow}>
                              ...
                              <View style={styles.dateRangeContainer}>
                                <Text style={styles.detailSubLabel}>From: </Text>
                                <Text style={styles.detailValue}>
                                  {leave.from_date}
                                </Text>
                                <Text style={styles.detailSubLabel}> To: </Text>
                                <Text style={styles.detailValue}>
                                  {leave.to_date}
                                </Text>
                              </View>
                      ...
                      {/* Permission Details (for Permission type) */}
                      {leave.leave_appln_type === 'Permission' && (
                        <>
                          <View style={styles.detailRow}>
                            <Text style={styles.detailLabel}>Permission Date:</Text>
                            <Text style={styles.detailValue}>
                              {leave.prmsn_date}
                            </Text>
                          </View>
